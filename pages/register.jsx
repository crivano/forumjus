      ...
      <div className="row" key={i}>
        ...
        <div className="col col-12 col-lg-6">
          <Form.Group className="mb-3" controlId="statementCommittee">
            ...
            <Form.Control as="select" type="email" value={statement[i].committee} onChange={(evt) => handleChangeStatementCommittee(evt, i)} >
        ...
        <div className="col col-12 col-md-6">
          <Form.Group className="mb-3" controlId="statementText">
            ...
            <Form.Control as="textarea" rows="10" value={statement[i].text} onChange={(evt) => handleChangeStatementText(evt, i)} />
        ...
        <div className="col col-12 col-md-6">
          <Form.Group className="mb-3" controlId="statementJustification">
            ...
            <Form.Control as="textarea" rows="10" value={statement[i].justification} onChange={(evt) => handleChangeStatementJustification(evt, i)} />
            <Form.Text className="text-muted">
          ...
          <Form>
            ...
            <div className="row" style={{ marginBottom: '6em' }}>
              ...
              <div className="col col-auto">
                <Button variant="primary" className="ml-auto" disabled={!attendeeName || !attendeeEmail || !attendeeDocument || !attendeeCategory || !statement || statement.find(s => !s.text || !s.justification || !s.committee)} onClick={handleClickRegister}>
                  Enviar
                </Button>
              </div>
            </div>
